...
import * as strings from 'PropertyFieldRoleDefinitionPickerWpWebPartStrings';
import PropertyFieldRoleDefinitionPickerWp from './components/PropertyFieldRoleDefinitionPickerWp';
import { IPropertyFieldRoleDefinitionPickerWpProps } from './components/IPropertyFieldRoleDefinitionPickerWpProps';
...
export interface IPropertyFieldRoleDefinitionPickerWpWebPartProps {
  description: string;
  searchValue: string;
  roleDefinitions: IRoleDefinitionInformation[];
}

export default class PropertyFieldRoleDefinitionPickerWpWebPart extends BaseClientSideWebPart<IPropertyFieldRoleDefinitionPickerWpWebPartProps> {
...
private _onSearch = (value: string): void => {
  ...
  public render(): void {
    const element: React.ReactElement<IPropertyFieldRoleDefinitionPickerWpProps> = React.createElement(
      PropertyFieldRoleDefinitionPickerWp,
      {
  ...
  protected onInit(): Promise<void> {
    this.properties.roleDefinitions = this.properties.roleDefinitions || [];
    this.properties.searchValue = this.properties.searchValue || '';
