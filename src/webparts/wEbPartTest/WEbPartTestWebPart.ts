...
import WEbPartTest from './components/WEbPartTest';
import { IWEbPartTestProps } from './components/IWEbPartTestProps';
...
export default class WEbPartTestWebPart extends BaseClientSideWebPart<IWEbPartTestWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IWEbPartTestProps> = React.createElement(
      WEbPartTest,
      {
