...
import type { IFieldPickerProps } from './IFieldPickerProps';
import { escape } from '@microsoft/sp-lodash-subset';
import welcomeDark from '../assets/welcome-dark.png';
import welcomeLight from '../assets/welcome-light.png';

export default class FieldPicker extends React.Component<IFieldPickerProps> {
  public render(): React.ReactElement<IFieldPickerProps> {
    ...
    return (
      <section className={`${styles.fieldPicker} ${hasTeamsContext ? styles.teams : ''}`}>
