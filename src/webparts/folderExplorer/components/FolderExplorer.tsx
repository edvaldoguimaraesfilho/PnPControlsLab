...
import type { IFolderExplorerProps } from './IFolderExplorerProps';
import { escape } from '@microsoft/sp-lodash-subset';
import welcomeDark from '../assets/welcome-dark.png';
import welcomeLight from '../assets/welcome-light.png';

export default class FolderExplorer extends React.Component<IFolderExplorerProps> {
  public render(): React.ReactElement<IFolderExplorerProps> {
    ...
    return (
      <section className={`${styles.folderExplorer} ${hasTeamsContext ? styles.teams : ''}`}>
