...
export default class PropertyPaneCheckboxWebPart extends BaseClientSideWebPart<IPropertyPaneCheckboxProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IPropertyPaneCheckboxProps> = React.createElement(
          ...
          groups: [
            {
              ...
              groupFields: [
               PropertyPaneCheckbox('showTitle', {  text: 'Show Title'})
              ]
            }
          ]
        }
