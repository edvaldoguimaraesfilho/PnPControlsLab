...
import type { IAccordionDemoProps } from './IAccordionDemoProps';
import { escape } from '@microsoft/sp-lodash-subset';
import welcomeDark from '../assets/welcome-dark.png';
import welcomeLight from '../assets/welcome-light.png';

export default class AccordionDemo extends React.Component<IAccordionDemoProps> {
  public render(): React.ReactElement<IAccordionDemoProps> {
    ...
    return (
      <section className={`${styles.accordionDemo} ${hasTeamsContext ? styles.teams : ''}`}>
