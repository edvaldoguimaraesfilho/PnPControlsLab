...
import CopiloTTeste from './components/CopiloTTeste';
import type { ICopiloTTesteProps } from './components/ICopiloTTesteProps';
import type { ICopiloTTesteCopilotComponentProperties } from './CopiloTTesteCopilotComponentProperties';

import * as strings from 'CopiloTTesteCopilotComponentStrings';
 ...
 */
export default class CopiloTTesteCopilotComponent extends BaseCopilotComponent<ICopiloTTesteCopilotComponentProperties> {
  ...
  protected render(): void {
    const props: ICopiloTTesteProps = {
    ...
    ReactDOM.render(React.createElement(CopiloTTeste, props), this.context.domElement);
  }
